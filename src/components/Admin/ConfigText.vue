            ...
            <v-expansion-panels v-model="panel" multiple focusable>
                ...
                <v-expansion-panel-content>
                    <div class="Footer mt-10" style="width:100%; background-color:#0C9045;">
                        ...
                        <v-row class="py-6" v-if="!this.$vuetify.breakpoint.smAndDown" no-gutters>
                            <v-col cols="6" class="pl-5">
                            <p style="color:white;" class="articleSubText mr-6">당신의 아침과 함께할 모닝 축구 뉴스레터</p>
                            </v-col>
                            <v-spacer></v-spacer>
                            <v-col class="text-start" cols="2">
                            <p @click="goto('/introduce')" style="color:white; cursor:pointer;" class="articleSubText pl-16">매체소개</p>
                            <p @click="goto('/policy')" style="color:white; cursor:pointer;" class="articleSubText pl-16">청소년 보호정책</p>
                            <p @click="goto('/terms-of-use')" style="color:white; cursor:pointer;" class="articleSubText pl-16">서비스이용약관</p>
                            <p @click="goto('/privacy-policy')" style="color:white; cursor:pointer;" class="articleSubText pl-16">개인정보처리방침</p>
                            </v-col>
                        </v-row>
                        ...
                        <v-row class="py-6" no-gutters>
                            <v-col cols="12" class="pl-5">
                                ...
                                <p class="articleSubText" style="color: white">올데이풋볼 2019 - 2021 | 대표자 : 이학진 | {{add}} <br>
                                전화번호 : {{tel.replace(/-/gi,' - ')}} | FAX : 02 - 6944 - 9018 | 메일주소 : {{email}}<br>
                                사업자등록번호 : 832-86-02092 | 통신판매업신고 : 제2021-고양덕양구-1421호 | 직업정보제공사업 신고번호 : J1202020210005<br>
                                발행인 : {{pub}} | 편집인: {{edi}} | 청소년보호정책책임자: {{pol}}<br><br>
                                Copyright © 2019 by alldayfootball. All rights reserved.
                                </p>
                                </div>
                            </v-col>
                        </v-row>
                        ...
                        <v-expansion-panels>
                            ...
                            <v-expansion-panel-content color="#0C9045">
                                ...
                                <p style="color:rgba(255,255,255,.8); text-align:center;" class="articleTinyText pa-1"> 올데이풋볼 2019 - 2021</p>
                                <p style="color:rgba(255,255,255,.8); text-align:center;" class="articleTinyText pa-1"> 대표자 : 이학진</p>
                                <p style="color:rgba(255,255,255,.8); text-align:center;" class="articleTinyText pa-1"> 전화번호: {{tel}}</p>
                                <p style="color:rgba(255,255,255,.8); text-align:center;" class="articleTinyText pa-1"> FAX : 02 - 6944 - 9018</p>
                                <p style="color:rgba(255,255,255,.8); text-align:center;" class="articleTinyText pa-1"> 사업자등록번호 : 832-86-02092</p>
                                ...
                                <p style="color:rgba(255,255,255,.8); text-align:center;" class="articleTinyText pa-2"> Copyright © 2019 by alldayfootball. All rights reserved.</p>
                                </v-col>
                            </v-expansion-panel-content>
                            </v-expansion-panel>
                        </v-expansion-panels>
                ...
                <v-expansion-panel class="my-5">
                <v-expansion-panel-header><p class="mainSubText">후기 관리</p></v-expansion-panel-header>
                <v-expansion-panel-content>
                    <v-row class="my-5">
                        <v-col cols="12">
...
export default {
    ...
    methods:{
        ...
        clickEdit(){
            axios.put(`${this.thisUrl}api/config/edit`,{
        ...
        getConfig(){
            axios.get(`${this.thisUrl}api/config/find`)
            .then((res)=>{
